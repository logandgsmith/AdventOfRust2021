// Advent of Code Day 6 Part 2 (12/06/21)
// Written in Rust!
// Author: Logan D.G. Smith
// NOTE: Easiest pt. 2 of this year. Same program, but with updated days var.
...
fn simulate_day(lifespans: &mut VecDeque<u64>) {
    // Spawners
...
fn main() {
    // Declarations
    let days: usize = 256;
    let mut lifespans: VecDeque<u64> = VecDeque::from(vec![0; 9]);
